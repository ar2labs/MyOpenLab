...
public class StatusAddElement extends Object implements StatusBasisIF {
  ...
  public StatusAddElement(
      VMObject vmobject, String mainPath, String circuitClass, String panelClass, String[] args) {
    String binPath = "bin/";
  ...
  private void appendMCUFlowChartElementTo(Element element, Element toAppend) {
    ...
    if (pinsBottom == 1 && pinsTop == 1) {
      ...
      if (element.getPin(pinBottomNr).draht != null) {
        ...
        Draht draht1 =
            vmobject.addDrahtIntoCanvas(element.getID(), pinBottomNr, toAppend.getID(), pinTopNr);
        ...
        int pinBottomNrDummyElement =
            dummyElement.getPinsTop()
                + dummyElement.getPinsRight()
                + dummyElement.getPinsBottom()
                - 1;
        ...
        Draht draht2 =
            vmobject.addDrahtIntoCanvas(
                dummyElement.getID(),
                pinBottomNrDummyElement,
                elementUnten.getID(),
                pinTopNrelementUnten);
  ...
  public Element getNearstElementInMouseExcludeElement(
      int x, int y, int d, int abY, Element elementToExclude) {
    Element elementX;
