...
public class StatusLineVertikal extends Object implements StatusBasisIF {
  ...
  public StatusLineVertikal(
      VMObject vmobject, ArrayList drahtPoints, int sourceElementID, int sourcePin, Point start) {
  ...
  private void createCursors() {
    ...
    img = vmobject.getToolkit().createImage(getClass().getResource("/Images/check.gif"));
    CheckCursor = vmobject.getToolkit().createCustomCursor(img, new Point(4, 4), "CheckOK");

    img = vmobject.getToolkit().createImage(getClass().getResource("/Images/cross.gif"));
  ...
  public void mouseMoved(MouseEvent e) {
    ...
    if (pan != null) {
      ...
      if ((sourceDataType == pan.dataType
          ...
          && ((pan.pinIO == JPin.PIN_INPUT || pan.pinIO == JPin.PIN_INPUT_OUTPUT)
              && pan.draht == null)) {
