...
public class StatusIdle extends Object implements StatusBasisIF {
  ...
  public StatusIdle(VMObject basis) {
    ...
    JMenuItem jmiAddNode =
        new JMenuItem(
            java.util.ResourceBundle.getBundle("BasisStatus/StatusIdle").getString("AddNode"));
    JMenuItem jmiAddTestpoint =
        new JMenuItem(
            java.util.ResourceBundle.getBundle("BasisStatus/StatusIdle").getString("AddTestpoint"));
    popDraht.add(jmiAddNode);
    popDraht.add(jmiAddTestpoint);

    jmiAddNode.addActionListener(
    ...
    jmiAddTestpoint.addActionListener(
        new java.awt.event.ActionListener() {
    ...
    JMenuItem menuitem1 =
        new JMenuItem(
            java.util.ResourceBundle.getBundle("BasisStatus/StatusIdle").getString("Loeschen"));

    JMenuItem menuitem3 =
        new JMenuItem(
            java.util.ResourceBundle.getBundle("BasisStatus/StatusIdle")
                .getString("am_Raster_ausrichten"));

    JMenuItem menuitem4 =
        new JMenuItem(
            java.util.ResourceBundle.getBundle("BasisStatus/StatusIdle").getString("Code-Editor"));

    JMenuItem menuitemElementProperties =
        new JMenuItem(
            java.util.ResourceBundle.getBundle("BasisStatus/StatusIdle")
                .getString("ElementProperties"));

    JMenuItem menuitemDocEditor =
        new JMenuItem(
            java.util.ResourceBundle.getBundle("BasisStatus/StatusIdle").getString("DocEditor"));

    JMenuItem menuitem5 =
        new JMenuItem(
            java.util.ResourceBundle.getBundle("BasisStatus/StatusIdle").getString("Element_Info"));

    mnuReihenfolge =
        new JMenu(
            java.util.ResourceBundle.getBundle("BasisStatus/StatusIdle").getString("Reihenfolge"));

    JMenuItem jmiReienfolge1 =
        new JMenuItem(
            java.util.ResourceBundle.getBundle("BasisStatus/StatusIdle")
                .getString("In_den_Vordergrund"));

    JMenuItem jmiReienfolge2 =
        new JMenuItem(
            java.util.ResourceBundle.getBundle("BasisStatus/StatusIdle")
                .getString("In_den_Hintergrund"));

    JMenuItem jmiReienfolge3 =
        new JMenuItem(
            java.util.ResourceBundle.getBundle("BasisStatus/StatusIdle")
                .getString("Eine_Ebene_nach_vorne"));

    JMenuItem jmiReienfolge4 =
        new JMenuItem(
            java.util.ResourceBundle.getBundle("BasisStatus/StatusIdle")
                .getString("Eine_Ebene_nach_hinten"));
    ...
    jmiReienfolge1.addActionListener(
        new java.awt.event.ActionListener() {
    ...
    jmiReienfolge2.addActionListener(
        new java.awt.event.ActionListener() {
    ...
    jmiReienfolge3.addActionListener(
        new java.awt.event.ActionListener() {
    ...
    jmiReienfolge4.addActionListener(
        new java.awt.event.ActionListener() {
    ...
    menuitemDocEditor.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    menuitemElementProperties.addActionListener(
        new java.awt.event.ActionListener() {
          ...
          public void actionPerformed(java.awt.event.ActionEvent evt) {
            ...
            if (aktuellesElement.classRef != null) {
              for (int i = 0; i < getBasis().getElementCount(); i++) {
                Element element = getBasis().getElement(i);
                if (element.isSelected()) {
                  CodeEditor.FormDefinitonDefEditor frm =
                      new CodeEditor.FormDefinitonDefEditor(getBasis().owner.frameCircuit, true);
        ...
        new java.awt.event.ActionListener() {
          ...
          public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (aktuellesElement != null) {
              ...
              if (file.exists()) {
                DFProperties thisDirProps = Tools.getPropertiesFromDefinitionFile(file);
  ...
  public void showElementInfo() {
    if (aktuellesElement != null) {
      BasisStatus.FormElementInfo frm = new BasisStatus.FormElementInfo(null, true);
  ...
  public void elementPinMousePressed(MouseEvent e, int elementID, int pin) {
    ...
    if (xpin != null
        && xpin.draht == null
        && (xpin.pinIO == JPin.PIN_OUTPUT || xpin.pinIO == JPin.PIN_INPUT_OUTPUT)) {
  ...
  public void mouseDragged(MouseEvent e) {
    ...
    } else if (e.getX() >= vmObject.getWidth() - 10
        && e.getY() >= vmObject.getHeight() - 10
        && e.getX() <= vmObject.getWidth()
        && e.getY() <= vmObject.getHeight()) {
  ...
  private int getResizeRect(Element element, int x, int y) {
    ...
    if (element.resizable) {
      ...
      {
        if (x > element.getWidth() / 2 - dist / 2
            && y > 0
            && x < element.getWidth() / 2 + dist
            && y < dist) {
          return 2;
        } else // Top-Width
        {
          ...
          } else // Left
          {
            ...
            {
              if (x > element.getWidth() - dist
                  && y > element.getHeight() / 2 - dist / 2
                  && x < element.getWidth() + dist
                  && y < element.getHeight() / 2 + dist / 2) {
                return 5;
              } else // Left-Height
              {
      ...
      if (x > element.getWidth() / 2 - dist / 2
          && y > element.getHeight() - dist
          && x < element.getWidth() / 2 + dist / 2
          && y < element.getHeight() + dist) {
        return 7;
      } else // Width-Height
      {
        if (x > element.getWidth() - 10
            && y > element.getHeight() - 10
            && x < element.getWidth()
            && y < element.getHeight()) {
          return 8;
        } else {
  ...
  public void mouseMoved(MouseEvent e) {
    ...
    if (vmObject.newElement != null) {
      ...
      if (circuitClass.endsWith("vlogic")) {
        ...
        mainPath = "/FrontElements/VMElement";
    ...
    if (e.getX() >= vmObject.getWidth() - 10
        && e.getY() >= vmObject.getHeight() - 10
        && e.getX() <= vmObject.getWidth()
        && e.getY() <= vmObject.getHeight()) {
