...
class AdvancedColorEditor extends JPanel implements PEIF {
  ...
  public void setValue(
      ...
      Color color1,
      Color color2,
      int color1Transparency,
      int color2Transparency,
      boolean wiederholung) {
    referenz.setValue(
        modus, p1, p2, color1, color2, color1Transparency, color2Transparency, wiederholung);
    item.processChanged();
  }
  ...
  public AdvancedColorEditor(
      PropertyEditorItem item, JFrame frame, VSColorAdvanced referenz, double min, double max) {
    super();
    this.referenz = referenz;
    this.item = item;
          ...
          public void mousePressed(java.awt.event.MouseEvent evt) {
            ...
            if (frm.result) {
              setValue(
                  ...
                  frm.color1,
                  frm.color2,
                  frm.color1Transparency,
                  frm.color2Transparency,
                  frm.wiederholung);
            }
          }
        });
...
class ColorEditor extends JPanel implements PEIF {
  ...
  public ColorEditor(
      PropertyEditorItem item, JFrame frame, VSColor referenz, double min, double max) {
    super();
          ...
          public void mousePressed(java.awt.event.MouseEvent evt) {
            Color bgColor =
                JColorChooser.showDialog(
                    getFrame(),
                    java.util.ResourceBundle.getBundle("Peditor/PropertyEditor")
                        .getString("Choose Background Color"),
                    getColor());
            if (bgColor != null) {
              setColor(bgColor);
            }
...
class OpenPropertyDialogEditor extends JPanel implements PEIF {
  ...
  public OpenPropertyDialogEditor(
      PropertyEditorItem item, Element element, VSPropertyDialog referenz) {
    super();
    this.item = item;
...
class PropertiesEditor extends JButton implements PEIF, ActionListener {
  ...
  public PropertiesEditor(
      PropertyEditorItem item, JFrame frame, VMObject vmobject, VSProperties referenz) {
    super();
...
public class PropertyEditor extends javax.swing.JPanel {
  ...
  public void setElement(Element element) {
    ...
    addItem(
        java.util.ResourceBundle.getBundle("Peditor/PropertyEditor").getString("caption"),
        element.vCaption,
        0,
        0,
        true);
    addItem(
        java.util.ResourceBundle.getBundle("Peditor/PropertyEditor").getString("Show_Caption"),
        element.vShowCaption,
        0,
        0,
        true);
    addItem(
        java.util.ResourceBundle.getBundle("Peditor/PropertyEditor").getString("Left"),
        element.vLeft,
        0,
        999999,
        true);
    addItem(
        java.util.ResourceBundle.getBundle("Peditor/PropertyEditor").getString("Top"),
        element.vTop,
        0,
        999999,
        true);
    ...
    if (element.owner == element.owner.owner.getFrontBasis()) {
      addItem(
          java.util.ResourceBundle.getBundle("Peditor/PropertyEditor").getString("Visible"),
          element.vVisible,
          0,
          0,
          true);
    ...
    addItem(
        java.util.ResourceBundle.getBundle("Peditor/PropertyEditor").getString("Width"),
        element.vWidth,
        0,
        99999,
        editable);
    addItem(
        java.util.ResourceBundle.getBundle("Peditor/PropertyEditor").getString("Height"),
        element.vHeight,
        0,
        99999,
        editable);
  ...
  private void initComponents() {
    ...
    jScrollPane1.addComponentListener(
        new java.awt.event.ComponentAdapter() {
          public void componentResized(java.awt.event.ComponentEvent evt) {
    ...
    jSplitPane1.addVetoableChangeListener(
    ...
    leftPanel.setMinimumSize(new java.awt.Dimension(50, 0));
    leftPanel.setPreferredSize(new java.awt.Dimension(150, 10));

    leftPanel.addComponentListener(
        new java.awt.event.ComponentAdapter() {
          public void componentResized(java.awt.event.ComponentEvent evt) {
    ...
    rightPanel.setPreferredSize(new java.awt.Dimension(60, 0));
  ...
  private void jSplitPane1VetoableChange(java.beans.PropertyChangeEvent evt)
      throws java.beans.PropertyVetoException {}

  private void jSplitPane1PropertyChange(java.beans.PropertyChangeEvent evt) {}

  private void jSplitPane1MouseReleased(java.awt.event.MouseEvent evt) {}

  private void leftPanelComponentResized(java.awt.event.ComponentEvent evt) {

    reorderItems();
  }

  private void rightPanelKeyPressed(java.awt.event.KeyEvent evt) {}

  private void rightPanelComponentResized(java.awt.event.ComponentEvent evt) {
    reorderItems();
  }
