...
public class MyGraph extends javax.swing.JPanel {
  ...
  public Boolean getBackgroundTransparent() {
    return Boolean.valueOf(graph.back.getBackgroundTransparent());
  }
  ...
  public Boolean getNullLineVisible() {
    return Boolean.valueOf(graph.back.nullLineVisible);
  }
  ...
  public Boolean getXYAxisVisible() {
    return Boolean.valueOf(graph.xyAxisVisible);
  }

  public Double getMinX() {
    return Double.valueOf(graph.xaxis.getMin());
  }

  public Double getMaxX() {
    return Double.valueOf(graph.xaxis.getMax());
  }

  public Boolean getAutoZoomX() {
    return Boolean.valueOf(graph.back.autoScaleX);
  }
  ...
  public Double getMinY() {
    return Double.valueOf(graph.yaxis.getMin());
  }

  public Double getMaxY() {
    return Double.valueOf(graph.yaxis.getMax());
  }

  public Boolean getAutoZoomY() {
    return Boolean.valueOf(graph.back.autoScaleY);
  }
  ...
  public Boolean getAutoScroll() {
    return Boolean.valueOf(graph.autoscroll);
  }

  public Boolean getCoordinatesVisible() {
    return Boolean.valueOf(graph.back.jLabel1.isVisible());
  }

  public Integer getPointType() {
    if (graph.graphRenderer.length > 0) return Integer.valueOf(graph.graphRenderer[0].pointType);
    else return Integer.valueOf(GraphRenderer.P_LINE_VBIG);
  }

  public Integer getbufferLen() {
    if (graph.graphRenderer.length > 0) return Integer.valueOf(graph.graphRenderer[0].bufferLen);
    else return Integer.valueOf(600);
  }
