...
public class DialogUpdate extends javax.swing.JDialog {
    ...
    new Thread() {
      public void run() {
        ...
        try {
          ...
          jButton2.setText(
              java.util.ResourceBundle.getBundle("VisualLogic/DialogUpdate").getString("Close"));
  ...
  private void initComponents() {
    ...
    jLabel1.setText(bundle.getString("Downloading..."));

    jButton1.setText(bundle.getString("Start_Download"));
    ...
    jLabel2.setText(bundle.getString("Aktuelle_Version_:_"));

    jLabel3.setText(bundle.getString("Neue_Version_:_"));
  ...
  private void jButton1ActionPerformed(
    ...
    if (downloadVersionFile("http://www.myopenlab.de/downloads/update.txt", supdateTXT)) {
      ...
      if (verX > ver) {
        ...
        download(
            "http://www.myopenlab.de/downloads/c-exp-lab.jar", parent.elementPath + "/update.jar");
