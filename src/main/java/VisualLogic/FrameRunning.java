...
public class FrameRunning extends javax.swing.JFrame {
  ...
  public FrameRunning(Basis basis, boolean unDecorated) {
    ...
    panelFront.setPreferredSize(
        new Dimension(basis.getFrontBasis().getWidth(), basis.getFrontBasis().getHeight()));
  ...
  private void initComponents() {
    ...
    jButton_PauseVM.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/pause.png")));
    java.util.ResourceBundle bundle =
        java.util.ResourceBundle.getBundle("VisualLogic/FrameCircuit");
    jButton_PauseVM.setToolTipText(bundle.getString("Pause_VM"));
    jButton_PauseVM.setPreferredSize(new java.awt.Dimension(25, 25));
    jButton_PauseVM.addActionListener(
    ...
    jButtonStopVM.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/stop.png")));
    jButtonStopVM.setToolTipText(bundle.getString("Stop_VM"));
    jButtonStopVM.setPreferredSize(new java.awt.Dimension(25, 25));
    jButtonStopVM.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jButtonStepVM.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/resume.png")));
    jButtonStepVM.setToolTipText(bundle.getString("Weiter_VM"));
    jButtonStepVM.setPreferredSize(new java.awt.Dimension(25, 25));
    jButtonStepVM.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jButtonDebugConsole.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jSpinnerDebugDelay.addChangeListener(
  ...
  private void jButtonDebugConsoleActionPerformed(
      java.awt.event.ActionEvent evt) // GEN-FIRST:event_jButtonDebugConsoleActionPerformed
  ...
  private void jSpinnerDebugDelayStateChanged(
      javax.swing.event.ChangeEvent evt) // GEN-FIRST:event_jSpinnerDebugDelayStateChanged
  ...
  private void jButtonAnalogWindowActionPerformed(
      java.awt.event.ActionEvent evt) // GEN-FIRST:event_jButtonAnalogWindowActionPerformed
  ...
  private void jButtonStepVMActionPerformed(
      java.awt.event.ActionEvent evt) // GEN-FIRST:event_jButtonStepVMActionPerformed
      { // GEN-HEADEREND:event_jButtonStepVMActionPerformed
    basis.resume();
  } // GEN-LAST:event_jButtonStepVMActionPerformed

  private void jButton_PauseVMActionPerformed(
      java.awt.event.ActionEvent evt) // GEN-FIRST:event_jButton_PauseVMActionPerformed
      { // GEN-HEADEREND:event_jButton_PauseVMActionPerformed
    basis.pause();
  } // GEN-LAST:event_jButton_PauseVMActionPerformed

  private void jButtonStopVMActionPerformed(
      java.awt.event.ActionEvent evt) // GEN-FIRST:event_jButtonStopVMActionPerformed
  ...
  private void jButtonTestPointActionPerformed(
      java.awt.event.ActionEvent evt) // GEN-FIRST:event_jButtonTestPointActionPerformed
  ...
  private void jButtonDigitalWindowActionPerformed(
      java.awt.event.ActionEvent evt) // GEN-FIRST:event_jButtonDigitalWindowActionPerformed
