...
/** * @author Salafia */
public class DialogNewJavaComponentAssistent extends javax.swing.JDialog
    implements ElementPaletteIF {
  ...
  public DialogNewJavaComponentAssistent(FrameMain frameCircuit, boolean modal) {
    ...
    col1.setHeaderValue(
        java.util.ResourceBundle.getBundle("VisualLogic/DialogNewJavaComponentAssistent")
            .getString("Name"));
    ...
    // elementPalette.currentDirectory="/CircuitElements/2user-defined/";
  ...
  private void initComponents() {
    ...
    java.util.ResourceBundle bundle =
        java.util.ResourceBundle.getBundle("VisualLogic/DialogNewJavaComponentAssistent");
    setTitle(bundle.getString("Create_Java_Component"));
    setResizable(false);
    ...
    jButton2.setText(bundle.getString("generate_new_Java_Element"));
    ...
    jRadioButton2.setText(bundle.getString("Front_Component"));
    ...
    jRadioButton2.addInputMethodListener(
    ...
    jRadioButton1.setSelected(true);
    jRadioButton1.setText(bundle.getString("Circuit_Component"));
    ...
    jLabel5.setText(bundle.getString("Dest_Directory_:_"));
                ...
                jPanel3Layout
                    ...
                    .addGroup(
                        jPanel3Layout
                            .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(
                                jPanel4, javax.swing.GroupLayout.DEFAULT_SIZE, 453, Short.MAX_VALUE)
                            .addGroup(
                                jPanel3Layout
                                    .createSequentialGroup()
        ...
        jPanel3Layout
            ...
            .addGroup(
                jPanel3Layout
                    ...
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    .addComponent(
                        jPanel4, javax.swing.GroupLayout.DEFAULT_SIZE, 334, Short.MAX_VALUE)
                    .addContainerGap()));

    jTabbedPane2.addTab(bundle.getString("Location"), jPanel3);

    jPanel7.setBorder(javax.swing.BorderFactory.createTitledBorder("Rezize options"));

    jCheckBox3.setText(bundle.getString("CircuitElement_resizable"));
    jCheckBox3.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0, 0, 0));
    jCheckBox3.setMargin(new java.awt.Insets(0, 0, 0, 0));

    jCheckBox4.setText(bundle.getString("FrontElement_resizable"));
    jCheckBox4.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0, 0, 0));
    jCheckBox4.setMargin(new java.awt.Insets(0, 0, 0, 0));

    jCheckBox5.setText(bundle.getString("CircuitElement_Resize_with_Aspectration"));
    jCheckBox5.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0, 0, 0));
    jCheckBox5.setMargin(new java.awt.Insets(0, 0, 0, 0));

    jCheckBox6.setText(bundle.getString("FrontElement_Resize_with_Aspectration"));
    ...
    jTable4.setModel(
        new javax.swing.table.DefaultTableModel(
          ...
          Class[] types =
              new Class[] {java.lang.String.class, java.lang.Object.class, java.lang.Object.class};
    ...
    jLabel6.setText(bundle.getString("pins_:"));

    jSpinner4.addChangeListener(
        new javax.swing.event.ChangeListener() {
          public void stateChanged(javax.swing.event.ChangeEvent evt) {
    ...
    jCheckBox9.setText(bundle.getString("PinsVisible"));
        ...
        jPanel6Layout
            ...
            .addGroup(
                jPanel6Layout
                    ...
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    .addComponent(
                        jScrollPane4, javax.swing.GroupLayout.DEFAULT_SIZE, 96, Short.MAX_VALUE)
                    .addContainerGap()));

    jTabbedPane1.addTab(bundle.getString("Top"), jPanel6);
    ...
    jLabel7.setText(bundle.getString("pins_:"));

    jSpinner5.addChangeListener(
        new javax.swing.event.ChangeListener() {
          public void stateChanged(javax.swing.event.ChangeEvent evt) {
    ...
    jCheckBox10.setText(bundle.getString("PinsVisible"));
        ...
        jPanel11Layout
            ...
            .addGroup(
                jPanel11Layout
                    ...
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    .addComponent(
                        jScrollPane6, javax.swing.GroupLayout.DEFAULT_SIZE, 96, Short.MAX_VALUE)
                    .addContainerGap()));

    jTabbedPane1.addTab(bundle.getString("Right"), jPanel11);
    ...
    jLabel8.setText(bundle.getString("pins_:"));

    jSpinner6.addChangeListener(
        new javax.swing.event.ChangeListener() {
          public void stateChanged(javax.swing.event.ChangeEvent evt) {
    ...
    jCheckBox11.setText(bundle.getString("PinsVisible"));
        ...
        jPanel12Layout
            ...
            .addGroup(
                jPanel12Layout
                    ...
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    .addComponent(
                        jScrollPane7, javax.swing.GroupLayout.DEFAULT_SIZE, 96, Short.MAX_VALUE)
                    .addContainerGap()));

    jTabbedPane1.addTab(bundle.getString("Bottom"), jPanel12);
    ...
    jLabel9.setText(bundle.getString("pins_:"));

    jSpinner7.addChangeListener(
        new javax.swing.event.ChangeListener() {
          public void stateChanged(javax.swing.event.ChangeEvent evt) {
    ...
    jCheckBox12.setText(bundle.getString("PinsVisible"));
        ...
        jPanel13Layout
            ...
            .addGroup(
                jPanel13Layout
                    ...
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    .addComponent(
                        jScrollPane8, javax.swing.GroupLayout.DEFAULT_SIZE, 96, Short.MAX_VALUE)
                    .addContainerGap()));

    jTabbedPane1.addTab(bundle.getString("Left"), jPanel13);

    jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Border"));

    jCheckBox1.setText(bundle.getString("show_InnerBoder"));
    jCheckBox1.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0, 0, 0));
    jCheckBox1.setMargin(new java.awt.Insets(0, 0, 0, 0));

    jCheckBox2.setText(bundle.getString("show_OuterBorder"));
    ...
    jLabel1.setText(bundle.getString("CircuitPanel_Element_Name_:_"));

    jLabel2.setText(bundle.getString("FrontPanel_Element_Name_:"));
    ...
    jTabbedPane2.addTab(bundle.getString("Settings"), jPanel10);
    ...
    jLabel3.setText(
        bundle.getString("Here_you_can_define_the_Properties_that_appear_in_the_Property-Editor"));
        ...
        jPanel1Layout
            ...
            .addGroup(
                jPanel1Layout
                    ...
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    .addComponent(
                        jScrollPane5, javax.swing.GroupLayout.DEFAULT_SIZE, 361, Short.MAX_VALUE)
                    .addContainerGap()));

    jTabbedPane2.addTab(bundle.getString("Properties"), jPanel1);

    jButton4.setText(bundle.getString("Save_Settings"));
    ...
    jButton3.setText(bundle.getString("Load_Settings"));
  ...
  private void jRadioButton2CaretPositionChanged(
      java.awt.event.InputMethodEvent evt) // GEN-FIRST:event_jRadioButton2CaretPositionChanged
  ...
  private void jRadioButton1StateChanged(
      javax.swing.event.ChangeEvent evt) // GEN-FIRST:event_jRadioButton1StateChanged
  ...
  public void check() {
    if (jRadioButton1.isSelected()) {
      elementPalette.currentDirectory = "/CircuitElements/2user-defined/";
      elementPalette.init(this, null, FrameMain.elementPath, elementPalette.currentDirectory);

      jCheckBox4.setEnabled(false);
      jCheckBox6.setEnabled(false);
    } else {
      elementPalette.currentDirectory = "/FrontElements/2user-defined/";
      elementPalette.init(this, null, FrameMain.elementPath, elementPalette.currentDirectory);
  ...
  private void jSpinner7StateChanged(
      javax.swing.event.ChangeEvent evt) // GEN-FIRST:event_jSpinner7StateChanged
  ...
  private void jSpinner6StateChanged(
      javax.swing.event.ChangeEvent evt) // GEN-FIRST:event_jSpinner6StateChanged
      { // GEN-HEADEREND:event_jSpinner6StateChanged
    int value = (Integer) jSpinner6.getValue();
    model3.setRowCount(value);
  } // GEN-LAST:event_jSpinner6StateChanged

  private void jSpinner5StateChanged(
      javax.swing.event.ChangeEvent evt) // GEN-FIRST:event_jSpinner5StateChanged
      { // GEN-HEADEREND:event_jSpinner5StateChanged
    int value = (Integer) jSpinner5.getValue();
    model2.setRowCount(value);
  } // GEN-LAST:event_jSpinner5StateChanged

  private void jSpinner4StateChanged(
      javax.swing.event.ChangeEvent evt) // GEN-FIRST:event_jSpinner4StateChanged
  ...
  private void jButton2ActionPerformed(
    ...
    group = elementPalette.currentDirectory;
    ...
    if (new File(str).exists()) {
      ...
      Tools.showMessage(
          this,
          java.util.ResourceBundle.getBundle("VisualLogic/DialogNewJavaComponentAssistent")
                  .getString("Directory_already_exists")
              + " : "
              + compName);
      return;
    }
      ...
      for (int pc = 0; pc < settings.pins.size(); pc++) {
        ...
        for (int i = 0; i < ps.items.size(); i++) {
          ...
          if (item.io.equalsIgnoreCase("input")) {
            String vsType = VSDataType.getPinDataType(item.intDT);
            out.write(
                "    input" + cc + "= (" + vsType + ")element.getPinInputReference(" + c + ");");
            out.newLine();
            cc++;
          }
          c++;
  ...
  public void generateCircuitJavaFile(String basisDestPath, String srcPath, int type) {
    try {
      ...
      if (settings.pins.size() == 4) {
        ...
        out.write(
            "    initPins(" + pinsTop + "," + pinsRight + "," + pinsBottom + "," + pinsLeft + ");");
        out.newLine();
        out.write(
            "    initPinVisibility("
                + pinsTopVisible
