...
public class FormTestPoints extends javax.swing.JFrame {
  ...
  public FormTestPoints(Basis basis) {
    initComponents();
    ...
    SwingUtilities.invokeLater(
        new Runnable() {
          public void run() {
            jScrollPane1
                .getViewport()
                .scrollRectToVisible(jTable1.getCellRect(jTable1.getRowCount(), 0, true));
          }
        });
  }
  ...
  private void initComponents() {
    ...
    java.util.ResourceBundle bundle =
        java.util.ResourceBundle.getBundle("VisualLogic/FormTestPoints");
    setTitle(bundle.getString("Testpoint_Window"));
    setAlwaysOnTop(true);
    ...
    jLabel1.setText(bundle.getString("Row_count_=_"));
