...
public class DialogNewProject extends javax.swing.JDialog {
  ...
  private void initComponents() {
    ...
    java.util.ResourceBundle bundle =
        java.util.ResourceBundle.getBundle("VisualLogic/DialogNewProject");
    setTitle(bundle.getString("New_Project"));
    ...
    Ok_btn.setText(bundle.getString("OK"));
    ...
    jPanel1.setBorder(
        javax.swing.BorderFactory.createTitledBorder(bundle.getString("NAME_AND_LOCATION")));

    jLabel1.setText(bundle.getString("Project_Name_:_"));

    jTextField1.setText(bundle.getString("project1"));
    ...
    jLabel2.setText(bundle.getString("Project_Location_:_"));

    jLabel3.setText(bundle.getString("Project_Folder_:"));

    FinalProjectPath.setEditable(false);

    ExploreFolder_btn.setText(bundle.getString("Browse..."));
    ExploreFolder_btn.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jCheckBox2.setText(bundle.getString("Create_Main_VM"));
    jCheckBox2.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0, 0, 0));
    jCheckBox2.setMargin(new java.awt.Insets(0, 0, 0, 0));

    MainVMName.setText("Main");

    jCheckSPSProjekt.setText(bundle.getString("MYOPENLAB_SPS_PROJEKT"));
    ...
    jCheckSPSProjekt.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
  ...
  private void make() {
    ...
    FinalProjectPath.setText(jTextField2.getText() + File.separator + jTextField1.getText());
  }

  private void jTextField2KeyReleased(
      java.awt.event.KeyEvent evt) // GEN-FIRST:event_jTextField2KeyReleased
      { // GEN-HEADEREND:event_jTextField2KeyReleased
    make();
  } // GEN-LAST:event_jTextField2KeyReleased

  private void jTextField1KeyReleased(
      java.awt.event.KeyEvent evt) // GEN-FIRST:event_jTextField1KeyReleased
      { // GEN-HEADEREND:event_jTextField1KeyReleased
    make();
  } // GEN-LAST:event_jTextField1KeyReleased

  private void jTextField1KeyPressed(
      java.awt.event.KeyEvent evt) // GEN-FIRST:event_jTextField1KeyPressed
      { // GEN-HEADEREND:event_jTextField1KeyPressed
  } // GEN-LAST:event_jTextField1KeyPressed

  private void jTextField1MouseClicked(
      java.awt.event.MouseEvent evt) // GEN-FIRST:event_jTextField1MouseClicked
  ...
  private void jTextField2KeyPressed(
      java.awt.event.KeyEvent evt) // GEN-FIRST:event_jTextField2KeyPressed
  ...
  private void ExploreFolder_btnActionPerformed(
      java.awt.event.ActionEvent evt) // GEN-FIRST:event_ExploreFolder_btnActionPerformed
  ...
  private void Ok_btnActionPerformed(
      java.awt.event.ActionEvent evt) // GEN-FIRST:event_Ok_btnActionPerformed
    ...
    if (!new File(projectName).exists()) {
      ...
      Tools.showMessage(
          java.util.ResourceBundle.getBundle("VisualLogic/DialogNewProject")
                  .getString("Folder_already_exist_:_")
              + "\""
              + projectName
              + "\"");
    }
  ...
  private void jCheckSPSProjektActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jCheckSPSProjektActionPerformed
