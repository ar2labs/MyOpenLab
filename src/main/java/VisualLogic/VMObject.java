...
public class VMObject extends JPanel
  ...
  public ExternalIF[] getElementList(VSBasisIF basis, String elementName) {
    ...
    ExternalIF[] result = new ExternalIF[list.size()];

    for (int i = 0; i < list.size(); i++) {
      result[i] = (ExternalIF) list.get(i);
    }
  ...
  public void processPropertyEditor() {
    if (owner.frameCircuit != null && owner.propertyEditor != null) {
      ...
      owner.propertyEditor.addItem(
          java.util.ResourceBundle.getBundle("VisualLogic/VMObject").getString("Width"),
          vsWidth,
          20,
          5000,
          true);
      owner.propertyEditor.addItem(
          java.util.ResourceBundle.getBundle("VisualLogic/VMObject").getString("Height"),
          vsHeight,
          20,
          5000,
          true);
      ...
      if (owner.WindowsPosition.selectedIndex
          == 5) { // IF user select "CUSTOM" enable editable X and Y Loation
        EditableTemp = true;
      } else {
        EditableTemp = false;
      }
      ...
      if (this == owner.getFrontBasis()) {
        ...
        owner.propertyEditor.addItem(
            ...
            EditableTemp);
        owner.propertyEditor.addItem(
            java.util.ResourceBundle.getBundle("VisualLogic/VMObject").getString("Color"),
            vsColor,
            20,
            5000,
            true);
        owner.propertyEditor.addItem(
            java.util.ResourceBundle.getBundle("VisualLogic/VMObject").getString("Title"),
            vsCaption,
            20,
            5000,
            true);
        owner.propertyEditor.addItem(
            java.util.ResourceBundle.getBundle("VisualLogic/VMObject").getString("Icon"),
            owner.vsIcon,
            0,
            0,
            true);
  ...
  public void saveAsJPEG(String sImgFilename) throws Exception {
    ...
    try {
      ...
      throw new Exception(
          java.util.ResourceBundle.getBundle("VisualLogic/VMObject")
  ...
  public void processAddElement(
      String mainPath, String circuitClass, String panelClass, String[] args) {
  ...
  public Element addElementIntoCanvas(
      String mainPath, String binPath, String circuitClass, String[] args) {
    owner.setChanged(true);
    ...
    try {
      ...
      int id = getObjectID();
      Element element =
          new Element(id, this, elementPath, mainPath, binPath, circuitClass, "", args);
      ...
      owner.showErrorMessage(
          circuitClass
              + java.util.ResourceBundle.getBundle("VisualLogic/VMObject")
                  .getString("Element_konnte_nicht_erfolgreich_erzeugt_werden_:")
              + ex.toString());
      unlockGraphics();
    }
  ...
  public Draht addDrahtIntoCanvas(
      int sourceElementID, int sourcePin, int destElementID, int destPin) {
    ...
    try {
      ...
      owner.showErrorMessage(
          java.util.ResourceBundle.getBundle("VisualLogic/VMObject")
                  .getString("Draht_konnte_nicht_erfolgreich_erzeugt_werden_:")
              + ex.toString());
    }
  ...
  public Draht addDraht(
      int id, int sourceElementID, int sourcePin, int destElementID, int destPin) {
    Draht dr = null;
    try {
      dr = new Draht(id, this, sourceElementID, sourcePin, destElementID, destPin);
  ...
  public void deleteOtherPanelElement(Element el) {
    ...
    try {
      ...
      System.out.println(
          "Error at VisualLogic.VMObject.deleteOtherPanelElement(VMObject.java:1487)");
    }
    try {
      if (el.classRef != null) {
  ...
  public Element AddDualElement(
      String mainPath, String binPath, String circuitClass, String panelClass, String[] args) {
    ...
    if (draht != null) {
      ...
      if (elementDest != null && elementDest.classRef != null) {
        try {
          ...
          Tools.jException(
              owner, "Error in xonProcess : " + ex + ", " + elementDest.getNameLocalized());
        } catch (Exception ex) {
          Tools.jException(
              owner, "Error in xonProcess : " + ex + ", " + elementDest.getNameLocalized());
        }
        ...
        try {
          elementDest.classRef.elementActionPerformed(
              new ElementActionEvent(draht.destPin, element));
        } catch (java.lang.AbstractMethodError ex) {
  ...
  public void setModusIdle() {
    ...
    if (owner.isEditable()) {
      status = leerLauf;
      if (owner.frameCircuit != null) {
        owner.frameCircuit.listAllElements();
      }
    }
  }
  ...
  public void markAllinRect(int x, int y, int xx, int yy) {
    ...
    for (int i = 0; i < elList.size(); i++) {
      ...
      if (element.isVisible()
          && element.getX() > x
          && element.getY() > y
          && (element.getX() + element.getWidth()) < xx
          && (element.getY() + element.getHeight()) < yy) {
  ...
  public Element[] getAllTestpointElements() {
    ...
    for (int i = 0; i < getElementCount(); i++) {
      ...
      if (element.getInternName().equalsIgnoreCase("###NODE###")
          && element.jGetTag(0) instanceof String) {
  ...
  private void FlowChartElementRekursivAbsteigenUndElementeInDerMitteAnordnen(Element elementX) {
    ...
    int pinBottomNr =
        elementX.getPinsTop() + elementX.getPinsRight() + elementX.getPinsBottom() - 1;
  ...
  private void reorderFlowChartLines() {
    ...
    for (int i = 0; i < vm.getElementCount(); i++) {
      ...
      if (elementX.getInternName().indexOf("#FLOWCHART") > -1
        ...
        if (pin != null && pin.pinIO == JPin.PIN_OUTPUT && pin.pinAlign == 2) {
          Draht draht = pin.draht;
  ...
  public void sortPinsForX(ArrayList list) {
    Element element = null;
    Element el1 = null;
    Element el2 = null;
    ...
    for (int j = list.size() - 1; j >= 0; j--) {
      for (int i = 0; i < j; i++) {
        ...
        if (x1 > x2) {
          ...
          Element b = (Element) list.get(i + 1);
          list.set(i, b);
          list.set(i + 1, a);
        }
      }
  ...
  public void sortPinsForY(ArrayList list) {
    Element element = null;
    Element el1 = null;
    Element el2 = null;
  ...
  public void getPinsAllXBar(String barName, ArrayList list) {
    for (int i = 0; i < getElementCount(); i++) {
      Element el = getElement(i);
  ...
  public void saveDraehte(FileSystemOutput fsOut, boolean onlySelected) {
    try {
      FileOutputStream fos =
          fsOut.addItem(
              java.util.ResourceBundle.getBundle("VisualLogic/VMObject").getString("Element"));
  ...
  public void readElements(
      int size, FileSystemInput fsIn, boolean fromAblage, ArrayList ElemetTabelle) {
    int id = -1;
    ...
    for (int i = 0; i < size; i++) {
      ...
      try {
        ...
        String classPfad = stream.readUTF();
        String className = stream.readUTF();

        int oldid = stream.readInt();
        ...
        if (fromAblage) {
          ...
          oldElementID = Integer.valueOf(oldid);
          newElementID = Integer.valueOf(id);
        ...
        String[] args = null;
        element =
            new Element(id, this, elementPath, mainPath, binPath, className, definitionPath, args);
        reserveObjectID(id, element);
        ...
        if (progressBar != null) {
          ...
          Tools.dialogWait.label2.setText(
              element.className
                  + ":"
                  + "\""
                  + element.getCaption()
  ...
  public void readDrahts(
    ...
    try {
      ...
      for (int i = 0; i < size; i++) {
        ...
        } else if (getElementWithID(sourceElementID) != null
            && getElementWithID(destElementID) != null
            && pinExist(sourceElementID, sourcePin)
            && pinExist(destElementID, destPin)) {
          id = oldid;
          Draht draht = addDraht(id, sourceElementID, sourcePin, destElementID, destPin);
          reserveObjectID(id, draht);
          draht.loadFromStream(stream);
  ...
  public void loadFromStream(FileSystemInput fsIn, boolean fromAblage, String ver) {
    if (owner.frameCircuit != null) {
      ...
      if (this == owner.getCircuitBasis()) {
        strText =
            java.util.ResourceBundle.getBundle("VisualLogic/Basic").getString("loadingCircuitVM");
      } else {
        strText =
            java.util.ResourceBundle.getBundle("VisualLogic/Basic").getString("loadingPanelVM");
      }
      if (Tools.dialogWait != null) {
    ...
    try {
      ...
      owner.showErrorMessage(
          java.util.ResourceBundle.getBundle("VisualLogic/VMObject")
                  .getString("Fehler_in_Basis.loadFromStream()_:")
              + ex.toString());
    }
  ...
  public Element getNearstElementInMouseExcludeElement(
      int x, int y, int d, Element elementToExclude) {
    Element element;
