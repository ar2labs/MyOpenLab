...
public class DialogSaveAsModul extends javax.swing.JDialog implements ElementPaletteIF {
  ...
  public void executeEditDirectory(String directory) {
    ...
    setTitle(
        java.util.ResourceBundle.getBundle("VisualLogic/ElementPalette").getString("edit_dir"));
    jPanel9.setVisible(false);

    jCheckBox1.setVisible(false);

    DFProperties definition_def = Tools.getPropertiesFromDefinitionFile(new File(directory));
  ...
  private void createDocDirsIfNotExist(String baseDir) {
    ...
    File doc_pt = new File(baseDir + "/doc_pt");
    ...
    if (!doc_es.exists()) {
      ...
      try (PrintWriter out = new PrintWriter(baseDir + "/doc_es/index.html")) {
        String html_es = html;
        html_es = html_es.replaceAll("#title#", "Aqui su Titulo");
        html_es = html_es.replaceAll("#body#", "Aqui el texto");
        out.println(html_es);
      } catch (FileNotFoundException ex) {
        Logger.getLogger(DialogSaveAsModul.class.getName()).log(Level.SEVERE, null, ex);
      }
    ...
    if (!doc_pt.exists()) {
      doc_pt.mkdirs();
      try (PrintWriter out = new PrintWriter(baseDir + "/doc_pt/index.html")) {
        String html_pt = html;
        html_pt = html_pt.replaceAll("#title#", "Aqui o seu título");
        html_pt = html_pt.replaceAll("#body#", "Aqui o seu texto");
        out.println(html_pt);
      } catch (FileNotFoundException ex) {
        Logger.getLogger(DialogSaveAsModul.class.getName()).log(Level.SEVERE, null, ex);
      }
    ...
    File description_pt = new File(baseDir + "/description_pt.html");

    if (!description_pt.exists()) {
      try (PrintWriter out = new PrintWriter(baseDir + "/description_pt.html")) {
        out.println("Text here!");
      } catch (FileNotFoundException ex) {
        Logger.getLogger(DialogSaveAsModul.class.getName()).log(Level.SEVERE, null, ex);
      }
  ...
  public void executeEdit(String baseDir) {
    ...
    editBaseDir = baseDir;
    setTitle(
        java.util.ResourceBundle.getBundle("VisualLogic/ElementPalette").getString("Menu_Edit"));
    txtName.setEnabled(false);
    ...
    DFProperties definition_def = Tools.getPropertiesFromDefinitionFile(new File(baseDir));
    ...
    if (new File(baseDir + "/description_pt.html").exists()) {
      txtDescriptionPT.setText(Tools.readFile(baseDir + "/description_pt.html"));
    }
    ...
    if (definition_def.vm.length() > 0) {
      txtName.setText(
          definition_def.vm.substring(0, definition_def.vm.length() - extension.length() - 1));
    }
    ...
    if (result) {
      ...
      try (PrintWriter out = new PrintWriter(baseDir + "/description_pt.html")) {
        out.println(txtDescriptionPT.getText());
      } catch (FileNotFoundException ex) {
        Logger.getLogger(DialogSaveAsModul.class.getName()).log(Level.SEVERE, null, ex);
      }
      ...
      if (!ff1.equalsIgnoreCase(ff2)) {
        ...
        try {
          ...
          Tools.showMessage(
              java.util.ResourceBundle.getBundle("VisualLogic/DialogSaveAsModul")
      ...
      // frameCircuit.elementPalette.loadFolder(frameCircuit.elementPalette.currentDirectory);
    }
  }
  ...
  public void executeNew() {
    ...
    if (result) {
      // 1. Generate directory for the element (under group!)
      // 2. Copy the icon from the source to the directory
      // 3. Generate definition.def in the directory
      ...
      // savedocFile(editorPT, baseDir + "/doc_pt.html");
      ...
      definition_def.captionPT = caption_PT;
  ...
  public void execute() {
    if (modeEdit == false) {
      ...
      if (c == 0) {
        elementPalette.currentDirectory = "/CircuitElements/";
        isCircuitElement = true;
      } else {
        elementPalette.currentDirectory = "/FrontElements/";
        isCircuitElement = false;
      }

      elementPalette.listOnlyUUIDs = true;
      elementPalette.init(this, null, basis.getElementPath(), elementPalette.currentDirectory);
  ...
  private void initComponents() {
    ...
    txtDescriptionPT = new javax.swing.JTextPane();
    ...
    setTitle(bundle.getString("Als_Modul_speichern"));
    setResizable(false);
    addWindowListener(
    ...
    java.util.ResourceBundle bundle1 =
        java.util.ResourceBundle.getBundle("VisualLogic/DialogSaveAsModul");
    jButton1.setText(bundle1.getString("CANCEL"));
    ...
    jButton2.setText(bundle1.getString("OK"));
    ...
    jLabel5.setText(bundle1.getString("NAME : "));

    jCheckBox1.setText(bundle1.getString("resize_proportional"));
    jCheckBox1.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0, 0, 0));
    jCheckBox1.setMargin(new java.awt.Insets(0, 0, 0, 0));

    jLabel6.setText(bundle1.getString("Description_Deutsch"));

    jScrollPane4.setViewportView(txtDescriptionES);

    jLabel2.setText(bundle1.getString("ICON"));

    jPanel2.setBackground(new java.awt.Color(255, 255, 255));
    jPanel2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
    jPanel2.setLayout(new java.awt.BorderLayout());

    txtIcon.addKeyListener(
    ...
    jButton4.setText(bundle1.getString("EDIT ICON"));
    ...
    jButton5.setText(bundle1.getString("Reload"));
    ...
    java.util.ResourceBundle bundle2 =
        java.util.ResourceBundle.getBundle("VisualLogic/FormOptions");
    jButton3.setText(bundle2.getString("durchsuchen"));
    ...
    jLabel1.setText(bundle1.getString("GERMAN"));

    txtDE.setPreferredSize(new java.awt.Dimension(100, 20));

    jLabel3.setText(bundle1.getString("ENGLISH"));

    jLabel4.setText(bundle1.getString("SPANISCH"));

    jLabel10.setText(bundle1.getString("PORTUGUESE"));

    jLabel7.setText(bundle1.getString("Description_Englisch"));

    jScrollPane5.setViewportView(txtDescriptionDE);

    jLabel9.setText(bundle1.getString("Beschreibng_Spanisch"));
    ...
    jTabbedPane1.addTab(bundle1.getString("Settings"), jPanel4);

    jButton6.setText(bundle1.getString("Open the Deutsch Documentation Directory"));
    ...
    jButton7.setText(bundle1.getString("Open the English Documentation Directory"));
    ...
    jButton8.setText(bundle1.getString("Open the Spanish Documentation Directory"));
    ...
    jButton9.setText(bundle1.getString("Open the Portuguese Documentation Directory"));
    ...
    jLabel8.setText(
        "Open the documentation directory to open index.html for editing with your HTML"
            + " editor");
    ...
    jTabbedPane1.addTab(bundle1.getString("Dokumentation"), jPanel9);
  ...
  public static String caption_PT = "";
  ...
  private javax.swing.JTextPane txtDescriptionPT;
