...
public class DialogRename extends javax.swing.JDialog {
  ...
  private void initComponents() {
    ...
    java.util.ResourceBundle bundle =
        java.util.ResourceBundle.getBundle("VisualLogic/DialogRename");
    setTitle(bundle.getString("RENAME"));
    setResizable(false);
    ...
    jLabel1.setText(bundle.getString("OLD NAME : "));
    ...
    jLabel2.setText(bundle.getString("NEW NAME : "));
