...
public class DialogAddEditvariable extends javax.swing.JDialog {
  ...
  private void initComponents() {
    ...
    java.util.ResourceBundle bundle =
        java.util.ResourceBundle.getBundle("VisualLogic/DialogAddEditvariable");
    jLabel2.setText(bundle.getString("VARIABLENAME"));
    ...
    jLabel1.setText(bundle.getString("DATATYPE"));
