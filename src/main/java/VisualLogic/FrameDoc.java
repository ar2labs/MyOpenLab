...
public class FrameDoc extends javax.swing.JDialog {
  ...
  public FrameDoc(java.awt.Frame parent) {
    ...
    jTabbedPane1.addTab(
        java.util.ResourceBundle.getBundle("VisualLogic/FrameDoc").getString("DOCUMENTATION"),
        panel);
  ...
  private void initComponents() {
    ...
    java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("VisualLogic/FrameDoc");
    jLabel1.setText(bundle.getString("ELEMENT :"));
    ...
    jTabbedPane1.addTab(bundle.getString("PINS"), jScrollPane1);
