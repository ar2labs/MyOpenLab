...
public class DialogDistributionAssistent extends javax.swing.JDialog {
  ...
  public DialogDistributionAssistent(
      java.awt.Frame parent, boolean modal, String projectPath, String driverPath) {
    super(parent, modal);
    initComponents();
  ...
  private void initComponents() {
    ...
    java.util.ResourceBundle bundle =
        java.util.ResourceBundle.getBundle("VisualLogic/DialogDistributionAssistent_es_ES");
    setTitle(bundle.getString("DISTRIBUTION ASSISTENT"));
    addMouseListener(
    ...
    jButton4.setText(bundle.getString("CREATE DISTRIBUTION"));
    ...
    jLabel1.setText(bundle.getString("MAIN_VM"));

    jLabel2.setText(bundle.getString("DEST_LOCATION"));

    jTextField1.setText(bundle.getString("JTEXTFIELD1"));
    ...
    jButton5.setText(bundle.getString("BROWSE"));
    ...
    jLabel3.setText(bundle.getString("PROJECT_NAME"));

    jTextField2.setEditable(false);
    jTextField2.setText(bundle.getString("JTEXTFIELD2"));

    jTextField3.setEditable(false);
    jTextField3.setText(bundle.getString("JTEXTFIELD3"));

    jLabel4.setText(bundle.getString("DEST_PATH"));

    jLabel5.setText(bundle.getString("DEST_NAME"));

    jTextField4.setText(bundle.getString("DISTRIBUTION1"));
  ...
  private void jTextField4KeyReleased(
      java.awt.event.KeyEvent evt) // GEN-FIRST:event_jTextField4KeyReleased
  ...
  private void jTextField4MouseReleased(
      java.awt.event.MouseEvent evt) // GEN-FIRST:event_jTextField4MouseReleased
  ...
  private void jTextField1MouseReleased(
      java.awt.event.MouseEvent evt) // GEN-FIRST:event_jTextField1MouseReleased
  ...
  private void jButton4ActionPerformed(
    ...
    if (jComboBox1.getSelectedItem() == null
        || ((String) jComboBox1.getSelectedItem()).length() == 0) {
      Tools.showMessage(
          this,
          java.util.ResourceBundle.getBundle("VisualLogic/DialogDistributionAssistent_es_ES")
