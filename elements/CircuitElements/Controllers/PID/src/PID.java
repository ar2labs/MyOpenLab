...
public class PID extends JVSMain {
  ...
  public void init() {
    ...
    if (strLocale.equalsIgnoreCase("pt_BR")) {
      ...
      element.jSetPinDescription(1, "e (Desvio)");
      element.jSetPinDescription(2, "Ta (Intervalo)");
      element.jSetPinDescription(3, "Kp");
      element.jSetPinDescription(4, "Ki");
      element.jSetPinDescription(5, "Kd");
    } else {
      element.jSetPinDescription(0, "y");
      element.jSetPinDescription(1, "e (Deviation)");
      element.jSetPinDescription(2, "Ta (Sampling time)");
      element.jSetPinDescription(3, "Kp");
      element.jSetPinDescription(4, "Ki");
      element.jSetPinDescription(5, "Kd");
    }
