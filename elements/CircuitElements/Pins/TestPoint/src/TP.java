...
public class TP extends JVSMain {
  ...
  public void checkPinDataType() {
    ...
    if (pinA == false)
      element.jSetPinIO(0, element.PIN_INPUT_OUTPUT);

    if (pinB == false)
      element.jSetPinIO(1, element.PIN_INPUT_OUTPUT);

    if (pinC == false)
      element.jSetPinIO(2, element.PIN_INPUT_OUTPUT);

    if (pinD == false)
      element.jSetPinIO(3, element.PIN_INPUT_OUTPUT);

    if (pinA == false) element.jSetPinVisible(0, false);
    else element.jSetPinVisible(0, true);

    if (pinB == false) element.jSetPinVisible(1, false);
    else element.jSetPinVisible(1, true);

    if (pinC == false) element.jSetPinVisible(2, false);
    else element.jSetPinVisible(2, true);

    if (pinD == false) element.jSetPinVisible(3, false);
    else element.jSetPinVisible(3, true);
