...
public class OutputPin extends JVSMain {
  private Image image;
  ...
  public void setPropertyEditor() {
    ...
    element.jAddPEItem("Ausgabetyp", dtPin, 0, 0);

    language = "en_US";
    element.jSetPEItemLocale(d + 0, language, "Output Type");

    language = "es_ES";
    element.jSetPEItemLocale(d + 0, language, "Tipo de Salida");

    language = "pt_BR";
    element.jSetPEItemLocale(d + 0, language, "Tipo de Saída");
  }
