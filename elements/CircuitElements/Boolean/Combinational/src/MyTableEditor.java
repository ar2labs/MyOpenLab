...
public class MyTableEditor extends javax.swing.JDialog {
  ...
  private void initComponents() {
    ...
    mniEditInputColumns.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    mniEraseInData.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    mniGenInputData.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/icon_generate.png")));
    mniGenInputData.setText("Generate Input Binary data");
    mniGenInputData.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    mniEditOutputColumns.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    mniEraseOutputData.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
  ...
  private void mniEraseOutputDataActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_mniEraseOutputDataActionPerformed
    int ok =
        JOptionPane.showConfirmDialog(
            this,
            "do you really wan't to delete output data ?",
            "Delete output data",
  ...
  private void mniEditOutputColumnsActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_mniEditOutputColumnsActionPerformed
  ...
  private void mniEraseInDataActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_mniEraseInDataActionPerformed
    int ok =
        JOptionPane.showConfirmDialog(
            this,
            "do you really wan't to delete input data ?",
            "Delete input data",
            JOptionPane.YES_NO_OPTION);
    if (ok == JOptionPane.YES_OPTION) {
  ...
  private void mniEditInputColumnsActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_mniEditInputColumnsActionPerformed
  ...
  private void mniGenInputDataActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_mniGenInputDataActionPerformed

    int ok =
        JOptionPane.showConfirmDialog(
            this,
            "do you really wan't to override \nand generate Input data ?",
            "Override input data",
            JOptionPane.YES_NO_OPTION);
    if (ok == JOptionPane.YES_OPTION) {
  ...
  public void eraseData(DefaultTableModel model) {
    for (int col = 0; col < model.getColumnCount(); col++)
      for (int row = 0; row < model.getRowCount(); row++) {
        model.setValueAt(Boolean.valueOf(false), row, col);
      }
  }
    ...
    String cols =
        (String)
            JOptionPane.showInputDialog(
                this, "Columns : ", "Edit Columns", JOptionPane.PLAIN_MESSAGE, null, null, str);
