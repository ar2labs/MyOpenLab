...
public class RS232v2 extends JVSMain implements MyOpenLabDriverOwnerIF {
  ...
  private VSBoolean useOwnInHandler = new VSBoolean(false);
  ...
  public void setPropertyEditor() {
    ...
    element.jAddPEItem("useOwnInHandler", useOwnInHandler, 0, 0);
  ...
  public void start() {
    ...
    args.add(useOwnInHandler.getValue());
  ...
  public void loadFromStream(java.io.FileInputStream fis) {
    ...
    useOwnInHandler.loadFromStream(fis);
  ...
  public void saveToStream(java.io.FileOutputStream fos) {
    ...
    useOwnInHandler.saveToStream(fos);
