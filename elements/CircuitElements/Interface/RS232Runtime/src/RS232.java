      ...
      case 3:
        {
          if (inSend.getValue()) {
            if (started == false) {
              ...
              args.add(Integer.valueOf(baud.getValue()));
              args.add(Integer.valueOf(bits.getValue()));
              args.add(Integer.valueOf(stopBits.getValue()));
              args.add(Integer.valueOf(parity.getValue()));
