...
public class Firmata extends JVSMain implements MyOpenLabDriverOwnerIF {
  ...
  public void pinMode(int pin, int mode) {
    ...
    byte bytes[] = new byte[] {(byte) (0xF4), (byte) (pin), (byte) (mode)};
  ...
  public void reportPin(int pin) {
    ...
    inBytes.setBytes(new byte[] {(byte) (0xD0 + (pin - 2)), (byte) (0x01)});
    if (driver != null) {
      if (debug) {
        System.out.println("REPORTPIN(" + pin + ")");
      }
  ...
  */
  public void queryCapatibilities() {
    ...
    // VS1DByte inBytes = new VS1DByte(1);
    inBytes.setBytes(new byte[] {(byte) 0xF0, (byte) 0x6B, (byte) 0xf7});
     ...
     */
    // VS1DByte inBytes = new VS1DByte(1);
    inBytes.setBytes(new byte[] {(byte) 0xF0, (byte) 0x69, (byte) 0xf7});
      ...
      case 13:
        {
          ...
          args.add(Integer.valueOf(57600));
