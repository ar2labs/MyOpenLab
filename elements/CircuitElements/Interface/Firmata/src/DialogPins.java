...
public class DialogPins extends javax.swing.JDialog {
    ...
    for (int i = 1; i < cap_rows.length; i++) {
      ...
      if (cap_cols.length == 2) {
        ...
        if (pinSettings.equalsIgnoreCase("NOT SUPPORTED")) {
          ...
          ((JSpinner.DefaultEditor) spinner_min.getEditor())
              .getTextField()
              .addKeyListener(
                  new KeyAdapter() {
                    @Override
          ...
          ((JSpinner.DefaultEditor) spinner_max.getEditor())
              .getTextField()
              .addKeyListener(
                  new KeyAdapter() {
                    @Override
      ...
      if (value.equals("SERVO_OUTPUT")) {
        ...
        res +=
            ac
                ...
                + value
                + "("
                + spinner_min.getValue()
                + ","
                + spinner_max.getValue()
                + ");\n";
      } else {
        res += ac + pinNo + "=" + value + ";\n";
      }
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      java.util.logging.Logger.getLogger(DialogPins.class.getName())
    ...
    java.awt.EventQueue.invokeLater(
        new Runnable() {
          ...
          public void run() {
            ...
            String capatibilities =
                "Firmata Protocol Version: 2.3 (StandardFirmata.ino)\n"
                    + "0=NOT SUPPORTED\n"
                    + "1=NOT SUPPORTED\n"
