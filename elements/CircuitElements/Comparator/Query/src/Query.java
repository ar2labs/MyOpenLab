...
public class Query extends JVSMain {
  private Image image;
  ...
  public void init() {
    ...
    if (strLocale.equalsIgnoreCase("pt_BR")) {
      element.jSetPinDescription(0, "Saida");
      element.jSetPinDescription(1, "a");
      element.jSetPinDescription(2, "Se (verdadeiro) saida=a se nao saida=b");
      element.jSetPinDescription(3, "b");
    }
