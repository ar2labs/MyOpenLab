...
public class Splitter extends JVSMain {
  ...
  public void paint(java.awt.Graphics g) {
    if (element != null) {
      ...
      for (int i = 0; i < anzPins.getValue(); i++) {
        g.drawLine(
            bounds.x + d, bounds.y + 5 + 10 * i, bounds.x + d + w - 5, bounds.y + 5 + 10 * i);
      }
    }
  }
  ...
  public void init() {
    ...
    // The pins are set automatically by the main program
    setName("splitter");

    element.jSetCaption("splitter");
  }
  ...
  private void localize() {
    ...
    language = "pt_BR";
    element.jSetPEItemLocale(d + 0, language, "TerminaIS de Saida");
  }
