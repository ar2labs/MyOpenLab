...
class SelectionListener implements ListSelectionListener {
  ...
  public void valueChanged(ListSelectionEvent e) {
    ...
    if (aktuellesCol != oldCol) {
      ...
      if (circuitElement != null) circuitElement.Change(1, Integer.valueOf(aktuellesCol));
      oldCol = aktuellesCol;
    }

    if (aktuellesRow != oldRow) {
      // System.out.println("Rows"+aktuellesRow);
      if (circuitElement != null) circuitElement.Change(2, Integer.valueOf(aktuellesRow));
      oldRow = aktuellesRow;
    }
