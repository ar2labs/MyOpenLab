    ...
    if (element != null) {
      ...
      if (circularNibble.getValue()) {
        ...
        g2.fillOval(
            ...
            bounds.y + 1 + bounds.height - (int) stand - 5,
            30 - 1,
            8);
        ...
        g2.drawLine(
            bounds.x + bounds.width - 30 + 1,
            bounds.y + bounds.height - (int) stand,
      ...
      if (TextVisible.getValue()) {
        ...
        for (double i = 0; i <= (double) (bounds.height - 10); i += fx) {
          ...
          g2.drawLine(
              bounds.x + bounds.width - 40, (int) i + 5, bounds.x + bounds.width - 30, (int) i + 5);
