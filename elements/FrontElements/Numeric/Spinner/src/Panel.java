...
public class Panel extends JVSMain {
  ...
  private void make() {
    SpinnerNumberModel model =
        new SpinnerNumberModel(
            Integer.valueOf(initValue.getValue()),
            Integer.valueOf(min.getValue()),
            Integer.valueOf(max.getValue()),
            Integer.valueOf(step.getValue()));
  ...
  public void start() {
    jSpinner.setValue(Integer.valueOf(initValue.getValue()));
    circuitElement = element.getCircuitElement();
