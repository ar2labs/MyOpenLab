...
public class GaugePanel extends JVSMain implements PanelIF {
  ...
  private static final RadialBargraph myGauge = new RadialBargraph();
  ...
  public void GaugeSet() {
    if (element != null) {
      ...
      for (LcdColor colorTemp : LcdColor.values()) {
        if (colorTemp
            .name()
            .equalsIgnoreCase(lcdDisplayColor.getItem(lcdDisplayColor.selectedIndex))) {
      ...
      for (NumberSystem numTemp : NumberSystem.values()) {
        if (numTemp
            .name()
            .equalsIgnoreCase(numberSystemCbox.getItem(numberSystemCbox.selectedIndex))) {
