...
public class GaugeCircuit extends JVSMain {
  ...
  public void checkPinDataType() {
    ...
    if (pinIn == true) {
      ...
      if (dt == element.C_DOUBLE) dt = element.C_DOUBLE;
      else if (dt == element.C_INTEGER) dt = element.C_INTEGER;
      else if (dt == element.C_BYTE) dt = element.C_BYTE;
      else dt = element.C_DOUBLE;
    }
