...
public class RGBPanel extends JVSMain implements PanelIF {
  private double value = 0.0;
  private static final Led myGauge = new Led();
  ...
  public void GaugeSet() {
    if (element != null) {
      myGauge.setLedBlinking(Blinking && Running);
  ...
  private void localize() {
    ...
    element.jSetPEItemLocale(d + 0, language, "Estado Inicial");
    element.jSetPEItemLocale(d + 1, language, "Tipo do LED");
    element.jSetPEItemLocale(d + 2, language, "Cor do LED");
    element.jSetPEItemLocale(d + 3, language, "Cor Personalizada");
  }
