...
public class Seg7 extends JVSMain {
  ...
  public void init() {
    ...
    element.jSetCaption("Seven segment Advertisement");

    setName("Seven-segment display");
  }
  ...
  public void process() {
    ...
    if (istEinValueChanged()) {
      ...
      if (panelElement != null) {
        panelElement.jProcessPanel(0, 0, Boolean.valueOf(a0));
        panelElement.jProcessPanel(1, 0, Boolean.valueOf(a1));
        panelElement.jProcessPanel(2, 0, Boolean.valueOf(a2));
        panelElement.jProcessPanel(3, 0, Boolean.valueOf(a3));
        panelElement.jProcessPanel(4, 0, Boolean.valueOf(a4));
        panelElement.jProcessPanel(5, 0, Boolean.valueOf(a5));
        panelElement.jProcessPanel(6, 0, Boolean.valueOf(a6));
        panelElement.jProcessPanel(7, 0, Boolean.valueOf(a7));
