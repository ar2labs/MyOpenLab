...
public class LEDPanel extends JVSMain implements PanelIF {
  ...
  public void paint(java.awt.Graphics g) {
    if (element != null) {
      ...
      if (on) light.setFillColor(col.getValue());
      else light.setFillColor(Color.black);
  ...
  private void localize() {
    ...
    element.jSetPEItemLocale(d, language, "Color");
    ...
    element.jSetPEItemLocale(d, language, "Cor");
  }
