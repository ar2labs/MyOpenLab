...
public class DataPanel extends JVSMain implements PanelIF {
  Rectangle bounds;
  ...
  public void paint(java.awt.Graphics g) {
    if (element != null) {
      ...
      if (xAchseLettersBottom) xAchseColor = Color.black;
      else xAchseColor = Color.white;
      if (yAchseLettersLeft) yAchseColor = Color.black;
      else yAchseColor = Color.white;
    ...
    ActionListener taskPerformer =
        new ActionListener() {
          public void actionPerformed(ActionEvent evt) {
            if (running == true) {
              if (in != null) {
                values.add(Double.valueOf(in.getValue()));
                element.jRepaint();
              }
            }
          }
  ...
  private void localize() {
    ...
    element.jSetPEItemLocale(d + 0, language, "Exibir Fundo");
    element.jSetPEItemLocale(d + 1, language, "Exibir Grid");
    element.jSetPEItemLocale(d + 2, language, "Tempo de Refresh [ms]");
  }
