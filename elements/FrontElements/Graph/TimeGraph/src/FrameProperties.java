...
public class FrameProperties extends javax.swing.JDialog {
  ...
  private void jBtnOKActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jBtnOKActionPerformed
    ...
    if (jRadioButton1.isSelected()) darstellungAs = 0;
    else darstellungAs = 1;
    ...
    if (jRadioButton4.isSelected()) xAchseBottom = true;
    else xAchseBottom = false;
    if (jRadioButton6.isSelected()) yAchseLeft = true;
    else yAchseLeft = false;
    if (jRadioButton8.isSelected()) xAchseLettersBottom = true;
    else xAchseLettersBottom = false;
    if (jRadioButton10.isSelected()) yAchseLettersLeft = true;
    else yAchseLettersLeft = false;
    result = true;
    dispose();
  } // GEN-LAST:event_jBtnOKActionPerformed

  private void jBtnCancelActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jBtnCancelActionPerformed
    result = false;
    dispose();
  ...
  public static boolean execute() {
    ...
    frm.jSpinnerZoomX.setValue(Integer.valueOf(zoomX));
    frm.jSpinnerZoomY.setValue(Integer.valueOf(zoomY));
    frm.jSpinnerStepX.setValue(Integer.valueOf(stepX));
    frm.jSpinnerStepY.setValue(Integer.valueOf(stepY));

    frm.jSpinnerMinX.setValue(Integer.valueOf(minX));
    frm.jSpinnerMaxX.setValue(Integer.valueOf(maxX));
    frm.jSpinnerMinY.setValue(Integer.valueOf(minY));
    frm.jSpinnerMaxY.setValue(Integer.valueOf(maxY));

    if (darstellungAs == 0) frm.jRadioButton1.setSelected(true);
    else frm.jRadioButton2.setSelected(true);
    ...
    if (xAchseBottom) frm.jRadioButton4.setSelected(true);
    else frm.jRadioButton3.setSelected(true);
    if (yAchseLeft) frm.jRadioButton6.setSelected(true);
    else frm.jRadioButton5.setSelected(true);
    if (xAchseLettersBottom) frm.jRadioButton8.setSelected(true);
    else frm.jRadioButton7.setSelected(true);
    if (yAchseLettersLeft) frm.jRadioButton10.setSelected(true);
    else frm.jRadioButton9.setSelected(true);
