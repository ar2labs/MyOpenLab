...
public class TimeGraphX extends JVSMain {
  ...
  public VSInteger bufferLen = new VSInteger(600);
  ...
  private void localize() {
    ...
    element.jSetPEItemLocale(d + 0, language, "Atraso");
    element.jSetPEItemLocale(d + 1, language, "Buffer");
    element.jSetPEItemLocale(d + 2, language, "Cor da Linha");
    element.jSetPEItemLocale(d + 3, language, "Pointtype");
  }
  ...
  public void start() {
    ...
    if (panelElement != null)
      panelElement.jProcessPanel(-2, bufferLen.getValue(), null);

    if (panelElement != null)
      panelElement.jProcessPanel(-3, 0, color);
    ...
    if (panelElement != null)
      panelElement.jProcessPanel(-5, 0, bufferLen);
